...
const handle = async (e) => {
  ...
  const quickLogin = (role) => {
    const creds = role==='consultant' ? 'eya@talan.com' : 'ahmed@talan.com'
    setEmail(creds); setPassword('password')
  }
    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="hidden lg:flex w-1/2 bg-navy flex-col justify-between p-12 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          {[...Array(6)].map((_,i) => (
            <div key={i} className="absolute border border-cyan rounded-full"
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            ...
            <span className="font-display text-white text-2xl font-bold tracking-tight">TALAN</span>
          </div>
          <h1 className="font-display text-white text-5xl font-bold leading-tight mb-6">
            Votre assistant<br/>
            <span className="text-cyan">intelligent</span><br/>
            d'entreprise
          </h1>
          <p className="text-slate-300 text-lg leading-relaxed max-w-md">
            Centralisez vos outils RH, CRM, Jira et Slack dans une interface conversationnelle unifiée.
          </p>
        </div>
        <div className="relative z-10 flex gap-6">
          {['RH', 'CRM', 'Jira', 'Slack', 'Calendar'].map(t => (
            <div key={t} className="bg-white/10 backdrop-blur px-3 py-1.5 rounded-lg">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex items-center gap-2 mb-10 lg:hidden">
            ...
            <span className="font-display text-navy text-xl font-bold">TALAN</span>
          </div>

          <h2 className="font-display text-navy text-3xl font-bold mb-2">Connexion</h2>
          ...
          <div className="mt-8 pt-6 border-t border-slate-100">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button onClick={()=>quickLogin('consultant')}
                ...
                <div className="text-blue-500 font-mono">eya@talan.com</div>
              </button>
              <button onClick={()=>quickLogin('pm')}
                ...
                <div className="font-medium mb-0.5">Project Manager</div>
                <div className="text-purple-500 font-mono">ahmed@talan.com</div>
              </button>
            </div>
            <p className="text-xs text-slate-400 mt-2 text-center">Mot de passe : <span className="font-mono">password</span></p>
          </div>
        </div>
      </div>
    </div>
